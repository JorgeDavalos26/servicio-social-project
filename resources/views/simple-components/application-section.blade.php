...
<tr>
    ...
    <td>
        {{ explode('_', $application['period']['label'])[array_key_last(explode('_', $application['period']['label']))] }}
    </td>
    <td>
        @php
            $color = '';
        ...
        @endphp
        <span class="<span forms-badge {{$color}}">
            {{ $application['status'] }}
        </span>
    </td>
    <td>
    ...
    <td>
        <div class="d-flex justify-content-around align-items-center">
            ...
            <a class="delete-form-icon" onclick="deleteSolicitude({{$application['id']}})" href="#">
