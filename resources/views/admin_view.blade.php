...
@section("script")
	...
	@vite(['resources/js/admin_view.js'])
						...
						<div class="btn-group " role="group">
							...
							<ul class="dropdown-menu" role="menu" aria-labelledby="actions">
								...
								<li>
									...
									<input id="lista-aceptados" style="visibility:hidden;display:none;" type="file" accept=".csv, application/vnd.openxmlformats-officedocument.spreadsheetml.sheet, application/vnd.ms-excel" /> 
								</li>
							</ul>
						</div>
					</div>
