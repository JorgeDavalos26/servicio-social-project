        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="mb-4">
                        <label class="control-label d-flex align-items-center" for="scholar-course-select">
                            Etapa por cursar
                        ...
                        <select id="scholar-course-select" name="scholar-course" class="form-control">
                            <option></option>
                            @foreach(\App\Helpers\Base_Enums\ScholarLevel::cases() as $scholarCourse)
                                <option value="{{$scholarCourse->name}}">
                                    {{\App\Helpers\Base_Enums\ScholarLevel::getText($scholarCourse)}}
                                </option>
                            @endforeach
                        </select>
                    </div>
                    ...
                    <div>
                        <label class="control-label d-flex align-items-center" for="registry-type-select">
                            Tipo de registro
                            <span class="help-icon ml-3" data-toggle="tooltip" data-placement="top"
                                  data-original-title="Ayuda">
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor"
                        ...
                        <select id="registry-type-select" name="registry-type" class="form-control">
                            <option></option>
                            @foreach(\App\Helpers\Base_Enums\ScholarCourse::cases() as $scholarCourse)
                                <option value="{{$scholarCourse->name}}">
                                    {{\App\Helpers\Base_Enums\ScholarCourse::getText($scholarCourse)}}
                                </option>
                            @endforeach
                        </select>
                    </div>
