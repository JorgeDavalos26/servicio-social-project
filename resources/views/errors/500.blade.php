...
@section("template")
    ...
    <div class="container pt-5">
        <div class="alert alert-danger">
            <br><br>
            <h2 class="display-3 m-0">Error 500 
            ...
            <p class="mt-4">Oops! Parece que el servidor no esta en buenas condiciones.</p>
            <p class="mt-2">Favor de contactar a servicio técnico o intentar mas tarde.</p>
            <br>
